<template>
  <div>
    <b-modal id="permisoFormModal" hide-footer 
      ...
      <div class="d-block">
          ...
          <br>
          <b-button class="float-right" v-on:click="Save()" variant="success" size="sm"><b-icon icon="file-earmark-check"></b-icon> Guardar</b-button>
      </div>
    </b-modal>
  </div>
</template>
